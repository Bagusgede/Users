...
<body class="uk-animation-fade">
    <div class="uk-container">
        ...
        <div uk-grid class="grid">
            <div class=" uk-card-body uk-width-1-3@m uk-width-1-1">
            ...
            ?>
                                <a href="update.php?id= <?= $data['id'] ?>" class="uk-icon-button uk-margin-small-right"
                                    uk-icon="check"></a><a href="delete.php?id= <?= $data['id'] ?>"
                                    class="uk-icon-button uk-margin-small-right" uk-icon="close"></a>
                            </button>
                            <br><br>
                            <?php endwhile;  ?>
            ...
            ?>
                                <a href="update.php?id= <?= $data['id'] ?>" class="uk-icon-button uk-margin-small-right"
                                    uk-icon="check"></a><a href="delete.php?id= <?= $data['id'] ?>"
                                    class="uk-icon-button uk-margin-small-right" uk-icon="close"></a> </button>
                            <br><br>
                            <?php endwhile;  ?>
                        </tr>
